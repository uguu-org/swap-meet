...
# Usage:
#
#     svg_to_png.sh input.png output.png
#     svg_to_png.sh input.png output.png dpi
#     svg_to_png.sh input.png output.png x1 y1 x2 y2
#     svg_to_png.sh input.png output.png x1 y1 x2 y2 dpi
#
...
if [[ $# -eq 6 ]]; then
   ...
   if [[ $# -eq 7 ]]; then
      ...
      if [[ $# -eq 3 ]]; then
         EXPORT_DPI="--export-dpi=$3"
         CACHED_OUTPUT="${PREFIX}_${INPUT_HASH}_${3}.png"
      fi
